...
BEGIN_EVENT_TABLE(treesheets::MyFrame, wxFrame)
  ...
  EVT_TEXT(A_SEARCH, treesheets::MyFrame::OnText)
  EVT_TEXT_ENTER(A_SEARCH, treesheets::MyFrame::OnTextEnter)
  EVT_TEXT_ENTER(A_REPLACE, treesheets::MyFrame::OnTextEnter)
